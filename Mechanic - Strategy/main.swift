...
PartsNStuff.instance.addApprovedMechanic(mechanicId: joe.mechanicId)
...
OrderManager.instance.fulfillOrder(order: order1)
OrderManager.instance.fulfillOrder(order: order2)
OrderManager.instance.fulfillOrder(order: order3)
